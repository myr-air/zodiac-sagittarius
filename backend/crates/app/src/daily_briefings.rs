...
use crate::auth;
use crate::place_resolution::resolve_destination_coordinates;
use sagittarius_db as db;
use sagittarius_db::PgPool;
use sagittarius_db::models::{ItineraryItemRecord, TripAuthRecord, TripDailyBriefingRecord};
use sagittarius_domain::capabilities::can;
use sagittarius_domain::errors::ServiceError;
use sagittarius_domain::patches::PatchDailyBriefingRequest;
...
mod tests {
    ...
    fn location_for_date_falls_back_to_destination_coordinates_when_item_has_no_coordinates() {
        let trip = TripAuthRecord {
            ...
            destination_cities: Json(vec![sagittarius_domain::types::TripCity {
