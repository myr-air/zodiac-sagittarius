...
fn role_capabilities_match_frontend_contract() {
    let cases = [
        ...
        (TripRole::Owner, Capability::CreateExpense, true),
        ...
        (TripRole::Organizer, Capability::CreateExpense, true),
        ...
        (TripRole::Traveler, Capability::CreateExpense, true),
        ...
        (TripRole::Viewer, Capability::CreateExpense, false),
