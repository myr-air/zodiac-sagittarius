...
use crate::db::models::{
    ...
    NewItineraryItem, NewPlanCheck, NewPlanSuggestion, NewPlanVariant, NewRealtimeEvent,
    NewStopNote, NewSuggestion, NewTripMember, NewTripTask, PlaceGeocodeCacheRecord,
    PlanCheckRecord, PlanSuggestionRecord, PlanVariantRecord, RealtimeEventRecord, StopNoteRecord,
