...
pub(crate) fn validate_plan_status_input(
    kind: Option<&str>,
    status: Option<&str>,
) -> Result<(), ServiceError> {
...
pub(crate) fn reject_main_plan_status(
    kind: Option<&str>,
    status: Option<&str>,
) -> Result<(), ServiceError> {
...
pub(crate) fn effective_plan_status<'a>(
    kind: Option<&'a str>,
    status: Option<&'a str>,
) -> Option<&'a str> {
...
pub(crate) fn validate_plan_status(value: &str) -> Result<(), ServiceError> {
    match value {
...
pub(crate) fn legacy_kind_for_plan_status(value: &str) -> &'static str {
    match value {
        "proposal" => "split",
        "main" => "main",
        "backup" => "backup",
