...
pub fn validate_amount_minor(value: i32) -> Result<(), ServiceError> {
    if value < 0 {
...
pub fn validate_exchange_rate(value: Option<f64>) -> Result<(), ServiceError> {
...
pub fn validate_expense_category(value: &str) -> Result<(), ServiceError> {
    match value {
...
pub fn validate_stored_value_transaction_type(
    value: Option<&str>,
) -> Result<(), ServiceError> {
    match value {
...
pub fn validate_stored_value_fields(
...
pub fn validate_splits(value: &Value) -> Result<(), ServiceError> {
    if !value.is_object() {
        return Err(ServiceError::InvalidRequest(
...
pub fn validate_line_items(value: Option<&Value>) -> Result<(), ServiceError> {
...
pub fn validate_comments(value: Option<&Value>) -> Result<(), ServiceError> {
    let Some(value) = value else {
        return Ok(());
    };
    if !value.is_array() {
...
pub fn validate_settlement_allocations(value: Option<&Value>) -> Result<(), ServiceError> {
    let Some(value) = value else {
        return Ok(());
    };
    if !value.is_array() {
...
pub fn validate_expense_splits_total(
    value: &Value,
    amount_minor: i32,
) -> Result<(), ServiceError> {
