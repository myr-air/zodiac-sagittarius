...
**Consequences**: Phase 0/1 must be treated as a contract phase. It may add aliases, validation, routes, migration columns, and tests, but it must not silently move actual expenses, flatten activities, remove legacy fields, or make unsupported duplicate/import plan creation look successful.
