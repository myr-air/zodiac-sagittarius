export const frontendItineraryScaffoldPathsPresent = [
  ...
  "src/features/itinerary/domain/route-map-day-groups.ts",
  "src/features/itinerary/domain/route-map-model.ts",
  "src/features/itinerary/domain/route-map-points.ts",
  "src/features/itinerary/domain/route-map-types.ts",
  "src/features/itinerary/domain/route-map-visible-state.ts",
  ...
  "src/features/itinerary/domain/stop-form-activity-input.ts",
  "src/features/itinerary/domain/stop-form-detail-type.ts",
  "src/features/itinerary/domain/stop-form-initial-values.ts",
  "src/features/itinerary/domain/stop-form-model.ts",
  "src/features/itinerary/domain/stop-form-submit-values.ts",
