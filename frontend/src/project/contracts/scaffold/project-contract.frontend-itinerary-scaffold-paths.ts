export const frontendItineraryScaffoldPathsPresent = [
  ...
  "src/features/itinerary/components/stop-dialog/tests/stop-dialog-time-fields.test.ts",
  "src/features/itinerary/components/stop-dialog/tests/stop-dialog.form-activity-input.test.ts",
  "src/features/itinerary/components/stop-dialog/tests/stop-dialog.form-defaults.test.ts",
