export const frontendAccountEmailLoginScaffoldPathsAbsent = [
  ...
  "src/features/account/components/account-access-panel/email-login/ui/account-email-login-fields.tsx",
  ...
  "src/features/account/components/account-access-panel/email-login/ui/account-email-login-step-stage.tsx",
  "src/features/account/components/account-access-panel/email-login/ui/account-email-login-step.types.ts",
  "src/features/account/components/account-access-panel/email-login/ui/account-email-login-styles.ts",
  ...
  "src/features/account/components/account-access-panel/email-login/components/account-email-login-step-content.tsx",
  "src/features/account/components/account-access-panel/email-login/components/account-email-login-step-labels.ts",
