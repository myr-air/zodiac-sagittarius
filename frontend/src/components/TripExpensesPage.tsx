...
const expensesPageClassName = "expenses-page grid min-h-full min-w-0 grid-rows-[auto_minmax(0,1fr)] gap-3 bg-[linear-gradient(180deg,#f7fbfa_0%,var(--color-page)_46%)] px-6 py-[22px] pb-7 max-[767px]:px-3 max-[767px]:py-4";
const expensesSummaryClassName = "expenses-summary grid grid-cols-4 gap-3 max-[1199px]:grid-cols-2 max-[767px]:grid-cols-1";
const statClassName = "expense-stat relative grid min-h-[112px] overflow-hidden rounded-[var(--radius-lg)] border border-[rgb(15_118_110_/_0.14)] bg-[linear-gradient(145deg,#ffffff_0%,#f4fffc_100%)] p-3.5 shadow-[0_14px_30px_rgb(15_23_42_/_0.06)] before:absolute before:right-2 before:top-2 before:size-[54px] before:rounded-full before:bg-[rgb(15_118_110_/_0.08)] [&_.icon]:relative [&_.icon]:z-[1] [&_.icon]:text-[var(--color-primary)] [&>span]:relative [&>span]:z-[1] [&>span]:text-xs [&>span]:font-bold [&>span]:text-[var(--color-text-muted)] [&>strong]:relative [&>strong]:z-[1] [&>strong]:text-2xl [&>strong]:font-extrabold [&>strong]:tabular-nums [&>strong]:text-[var(--color-text)]";
const contentGridClassName = "expenses-content grid min-h-0 grid-cols-[332px_minmax(0,1fr)] gap-3 max-[1199px]:grid-cols-1";
const panelClassName = "expenses-panel grid min-h-0 gap-3 rounded-[var(--radius-lg)] border border-[rgb(15_23_42_/_0.08)] bg-[rgb(255_255_255_/_0.94)] p-3.5 shadow-[0_14px_28px_rgb(15_23_42_/_0.05)]";
const panelHeadingClassName = "m-0 flex items-center gap-2 text-[14px] font-extrabold leading-5 text-[var(--color-text)]";
const balanceListClassName = "grid gap-2";
const balanceRowClassName = "grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 rounded-[var(--radius-md)] border border-[rgb(15_23_42_/_0.07)] bg-[var(--color-surface)] px-2.5 py-2 text-xs shadow-[0_8px_18px_rgb(15_23_42_/_0.035)]";
const settlementRowClassName = "grid grid-cols-1 items-start gap-2 rounded-[var(--radius-md)] border border-[rgb(249_115_22_/_0.18)] bg-[linear-gradient(135deg,#fff7ed_0%,#ffffff_78%)] px-2.5 py-2 text-xs";
const balanceActionsClassName = "inline-flex flex-wrap items-center justify-start gap-1.5";
const balanceNameClassName = "font-extrabold text-[var(--color-text)]";
const balanceMetaClassName = "text-[var(--color-text-muted)]";
const amountClassName = "font-extrabold tabular-nums";
const positiveClassName = "text-[#15803d]";
const negativeClassName = "text-[#b91c1c]";
const commandBarClassName = "expenses-command-bar grid content-start gap-3 rounded-[var(--radius-lg)] border border-[rgb(15_23_42_/_0.08)] bg-[rgb(255_255_255_/_0.96)] p-3.5 shadow-[0_14px_28px_rgb(15_23_42_/_0.05)] max-[767px]:p-3";
...
const copyFeedbackClassName = "expense-copy-feedback inline-flex min-h-9 items-center justify-center rounded-[var(--radius-sm)] border border-[var(--color-border)] bg-[var(--color-surface-subtle)] px-3 text-xs font-extrabold leading-4 text-[var(--color-text-muted)] data-[state=copied]:border-[var(--color-success-border)] data-[state=copied]:bg-[var(--color-success-soft)] data-[state=copied]:text-[var(--color-success)] data-[state=error]:border-[var(--color-danger-border)] data-[state=error]:bg-[var(--color-danger-soft)] data-[state=error]:text-[var(--color-danger)]";
const fieldClassName = "grid min-w-0 gap-1.5 [&>span]:text-[11px] [&>span]:font-extrabold [&>span]:text-[var(--color-text-muted)] [&_input]:min-h-10 [&_input]:rounded-[var(--radius-md)] [&_input]:border [&_input]:border-[var(--color-border)] [&_input]:bg-[var(--color-surface)] [&_input]:px-3 [&_input]:text-sm [&_select]:min-h-10 [&_select]:rounded-[var(--radius-md)] [&_select]:border [&_select]:border-[var(--color-border)] [&_select]:bg-[var(--color-surface)] [&_select]:px-3 [&_select]:text-sm [&_textarea]:min-h-[74px] [&_textarea]:resize-y [&_textarea]:rounded-[var(--radius-md)] [&_textarea]:border [&_textarea]:border-[var(--color-border)] [&_textarea]:bg-[var(--color-surface)] [&_textarea]:px-3 [&_textarea]:py-2 [&_textarea]:text-sm";
const tableWrapClassName = "min-h-0 overflow-auto rounded-[var(--radius-lg)] border border-[rgb(15_23_42_/_0.08)] bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-2 shadow-[0_14px_28px_rgb(15_23_42_/_0.05)]";
const tableClassName = "expense-ledger-table w-full min-w-[780px] border-separate border-spacing-y-2 text-left text-sm";
const tableHeaderClassName = "sticky top-0 z-[1] bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] text-[11px] font-black uppercase text-[var(--color-text-muted)] [&_th]:px-3 [&_th]:py-2";
const tableBodyClassName = "[&_td]:border-y [&_td]:border-[rgb(15_23_42_/_0.08)] [&_td]:bg-[var(--color-surface)] [&_td]:px-3 [&_td]:py-3 [&_td:first-child]:rounded-l-[var(--radius-md)] [&_td:first-child]:border-l [&_td:last-child]:rounded-r-[var(--radius-md)] [&_td:last-child]:border-r [&_tr:hover_td]:bg-[#fbfefd]";
const tableTitleClassName = "grid gap-1 [&_strong]:text-[var(--color-text)] [&_span]:text-xs [&_span]:text-[var(--color-text-muted)]";
...
const ledgerAmountClassName = "inline-flex min-h-8 items-center rounded-[var(--radius-sm)] bg-[var(--color-primary-soft)] px-2.5 text-[13px] font-black tabular-nums text-[var(--color-primary-strong)]";
const dialogBackdropClassName = "fixed inset-0 z-20 grid place-items-center bg-[rgb(15_23_42_/_0.28)] p-4";
const dialogClassName = "expense-dialog grid max-h-[min(720px,calc(100vh_-_32px))] w-full max-w-[760px] grid-rows-[auto_minmax(0,1fr)] overflow-hidden rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[0_24px_70px_rgb(15_23_42_/_0.28)]";
const dialogHeaderClassName = "grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 border-b border-[var(--color-border)] px-4 py-3 [&_h2]:m-0 [&_h2]:text-lg [&_h2]:font-extrabold";
...
const itemizedLineClassName = "grid gap-2 rounded-[var(--radius-sm)] border border-[var(--color-border)] bg-[var(--color-surface-subtle)] p-2.5";
...
const commentsClassName = "grid gap-2 rounded-[var(--radius-sm)] border border-[var(--color-border)] bg-[var(--color-surface-subtle)] p-2.5";
const commentRowClassName = "grid gap-0.5 rounded-[var(--radius-sm)] bg-[var(--color-surface)] px-2.5 py-2 text-xs [&_strong]:text-[var(--color-text)] [&_span]:text-[var(--color-text-muted)]";
const warningClassName = "rounded-[var(--radius-sm)] border border-[var(--color-warning-border)] bg-[var(--color-warning-soft)] px-2.5 py-2 text-xs font-bold text-[var(--color-warning-strong)]";
const dialogActionsClassName = "flex flex-wrap items-center justify-end gap-2 border-t border-[var(--color-border)] pt-3";
