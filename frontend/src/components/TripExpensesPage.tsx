...
const statClassName = "expense-stat relative grid min-h-[112px] overflow-hidden rounded-(--radius-lg) border border-[rgb(15_118_110_/_0.14)] bg-[linear-gradient(145deg,#ffffff_0%,#f4fffc_100%)] p-3.5 shadow-[0_14px_30px_rgb(15_23_42_/_0.06)] before:absolute before:right-2 before:top-2 before:size-[54px] before:rounded-full before:bg-[rgb(15_118_110_/_0.08)] [&_.icon]:relative [&_.icon]:z-[1] [&_.icon]:text-(--color-primary) [&>span]:relative [&>span]:z-[1] [&>span]:text-xs [&>span]:font-bold [&>span]:text-(--color-text-muted) [&>strong]:relative [&>strong]:z-[1] [&>strong]:text-2xl [&>strong]:font-extrabold [&>strong]:tabular-nums [&>strong]:text-(--color-text)";
const contentGridClassName = "expenses-content grid min-h-0 grid-cols-[332px_minmax(0,1fr)] gap-3 max-[1199px]:grid-cols-1";
const panelClassName = "expenses-panel grid min-h-0 gap-3 rounded-(--radius-lg) border border-[rgb(15_23_42_/_0.08)] bg-[rgb(255_255_255_/_0.94)] p-3.5 shadow-[0_14px_28px_rgb(15_23_42_/_0.05)]";
...
const balanceRowClassName = "grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 rounded-(--radius-md) border border-[rgb(15_23_42_/_0.07)] bg-(--color-surface) px-2.5 py-2 text-xs shadow-[0_8px_18px_rgb(15_23_42_/_0.035)]";
const settlementRowClassName = "grid grid-cols-1 items-start gap-2 rounded-(--radius-md) border border-[rgb(249_115_22_/_0.18)] bg-[linear-gradient(135deg,#fff7ed_0%,#ffffff_78%)] px-2.5 py-2 text-xs";
...
const commandBarClassName = "expenses-command-bar grid content-start gap-3 rounded-(--radius-lg) border border-[rgb(15_23_42_/_0.08)] bg-[rgb(255_255_255_/_0.96)] p-3.5 shadow-[0_14px_28px_rgb(15_23_42_/_0.05)] max-[767px]:p-3";
...
const tableWrapClassName = "min-h-0 overflow-auto rounded-(--radius-lg) border border-[rgb(15_23_42_/_0.08)] bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-2 shadow-[0_14px_28px_rgb(15_23_42_/_0.05)]";
const tableClassName = "expense-ledger-table w-full min-w-[780px] border-separate border-spacing-y-2 text-left text-sm";
const tableHeaderClassName = "sticky top-0 z-[1] bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] text-[11px] font-black uppercase text-(--color-text-muted) [&_th]:px-3 [&_th]:py-2";
...
const dialogClassName = "expense-dialog grid max-h-[min(720px,calc(100vh_-_32px))] w-full max-w-[760px] grid-rows-[auto_minmax(0,1fr)] overflow-hidden rounded-(--radius-md) border border-(--color-border) bg-(--color-surface) shadow-[0_24px_70px_rgb(15_23_42_/_0.28)]";
