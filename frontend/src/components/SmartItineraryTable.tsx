...
const dayClearPathButtonClassName = "inline-flex min-h-7 items-center rounded-(--radius-sm) border border-(--color-border) bg-(--color-surface) px-2 text-[11px] font-extrabold text-(--color-text-muted) disabled:opacity-40 max-[767px]:px-1.5";
const dayAutoOverlapButtonClassName = "inline-flex min-h-7 items-center rounded-(--radius-sm) border border-[#fca5a5] bg-[#fee2e2] px-2 text-[11px] font-extrabold text-[#991b1b] transition-colors hover:enabled:bg-[#fecaca] disabled:opacity-40 max-[767px]:px-1.5";
...
const rowActionButtonClassName = "row-action-button inline-grid size-[26px] place-items-center rounded-(--radius-sm) border-0 bg-transparent text-(--color-text-subtle) transition-[color,background] duration-150 hover:not-disabled:bg-(--color-primary-soft) hover:not-disabled:text-(--color-primary-strong) disabled:cursor-not-allowed disabled:opacity-[0.42]";
