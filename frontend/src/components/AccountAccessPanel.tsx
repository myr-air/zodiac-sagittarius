...
const accountToastStackClassName =
  "account-toast-stack pointer-events-none fixed bottom-6 right-[clamp(18px,4vw,44px)] z-[50] grid w-[min(420px,calc(100vw_-_40px))] gap-2.5 max-[767px]:inset-x-[18px] max-[767px]:bottom-5 max-[767px]:w-auto [&_.account-success]:pointer-events-auto [&_.account-success]:min-h-12 [&_.account-success]:w-full [&_.account-success]:justify-start [&_.account-success]:rounded-[var(--radius-lg)] [&_.account-success]:bg-[linear-gradient(90deg,rgb(22_163_74_/_0.08),rgb(255_255_255_/_0.96)_42%),rgb(255_255_255_/_0.96)] [&_.account-success]:shadow-[0_18px_44px_rgb(15_23_42_/_0.14)] [&_.join-alert]:pointer-events-auto [&_.join-alert]:min-h-12 [&_.join-alert]:w-full [&_.join-alert]:justify-start [&_.join-alert]:rounded-[var(--radius-lg)] [&_.join-alert]:bg-[linear-gradient(90deg,rgb(220_38_38_/_0.08),rgb(255_255_255_/_0.96)_42%),rgb(255_255_255_/_0.96)] [&_.join-alert]:shadow-[0_18px_44px_rgb(15_23_42_/_0.14)] [&>*]:account-toast-item";
