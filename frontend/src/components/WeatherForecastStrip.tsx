...
const segmentClassName =
  "weather-forecast-segment grid min-w-[72px] cursor-pointer gap-2 border-0 bg-transparent p-0 text-center font-inherit text-(--color-text) transition-[opacity,transform,filter] duration-200 hover:-translate-y-0.5 hover:opacity-95 focus-visible:outline focus-visible:outline-3 focus-visible:outline-offset-4 focus-visible:outline-[rgb(14_165_233_/_0.28)] max-[767px]:w-[106px] max-[767px]:shrink-0 max-[767px]:snap-center";
