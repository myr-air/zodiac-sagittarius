...
const overviewPanelClassName = "overview-panel grid min-h-40 min-w-0 max-w-full content-start gap-2.5 overflow-hidden rounded-(--radius-md) border border-(--color-border) bg-[linear-gradient(145deg,rgb(255_255_255_/_0.86),rgb(248_250_252_/_0.74)),var(--paper-grain),var(--color-surface)] bg-[length:auto,120px_120px,auto] p-4 [&>span]:text-xs [&>span]:font-bold [&>span]:text-(--color-text-muted) [&>strong]:text-xl [&>strong]:font-extrabold [&>strong]:leading-7 [&>strong]:text-(--color-text)";
...
const overviewHighlightBoardClassName = "overview-highlight-board mb-4 min-w-0 max-w-full overflow-hidden rounded-(--radius-lg) border border-(--color-border) bg-[linear-gradient(135deg,rgb(255_255_255_/_0.86),rgb(255_247_237_/_0.44)),var(--paper-grain),var(--color-surface)] bg-[length:auto,120px_120px,auto] p-3 shadow-[0_14px_32px_rgb(15_23_42_/_0.05)]";
