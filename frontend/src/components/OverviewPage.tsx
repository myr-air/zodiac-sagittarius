...
const overviewHeroBaseClassName = "overview-hero relative grid min-h-[228px] grid-cols-[minmax(0,1fr)_minmax(260px,320px)] items-center gap-6 overflow-hidden rounded-[var(--radius-lg)] border p-6 shadow-[0_14px_34px_rgb(15_23_42_/_0.07)]";
const overviewHeroCopyClassName = "overview-hero-copy relative z-[2] grid min-w-0 max-w-[760px] content-center gap-2.5";
const overviewHeroKickerClassName = "overview-hero-kicker w-fit max-w-full overflow-hidden rounded-full border bg-white/70 px-2.5 py-1.5 text-xs font-extrabold leading-4 text-ellipsis whitespace-nowrap";
...
const overviewHeroAsideClassName = "overview-hero-aside relative z-[2] grid min-w-0 content-center gap-2.5 self-center rounded-[var(--radius-lg)] border border-white/70 bg-white/80 p-3 shadow-[0_14px_30px_rgb(15_23_42_/_0.07)]";
const overviewHeroSettlementsClassName = "overview-hero-settlements justify-self-stretch rounded-full border bg-white/70 px-2.5 py-1.5 text-center text-xs font-extrabold leading-4";
const cockpitCardBaseClassName = "overview-cockpit-card grid min-h-[126px] min-w-0 content-start gap-2 rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface)] p-3.5 text-left shadow-[0_10px_24px_rgb(15_23_42_/_0.04)]";
