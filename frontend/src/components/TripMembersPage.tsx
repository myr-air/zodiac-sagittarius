...
const membersPageClassName = "members-page grid min-h-full min-w-0 grid-rows-[auto_minmax(0,1fr)] gap-3 bg-(--color-page) px-6 py-[22px] pb-7 max-[767px]:min-h-[calc(100dvh-48px)] max-[767px]:gap-0 max-[767px]:bg-(--color-surface) max-[767px]:px-0 max-[767px]:py-0 max-[767px]:pb-0";
const memberStatGridClassName = "member-stat-grid grid w-full grid-cols-5 gap-3 max-[1199px]:grid-cols-3 max-[767px]:grid-cols-1 max-[767px]:gap-0";
const memberStatClassName = "member-stat grid min-h-[126px] min-w-0 content-start gap-2 rounded-(--radius-md) border border-[color-mix(in_srgb,var(--color-route-border)_58%,var(--color-border))] bg-[linear-gradient(145deg,rgb(255_255_255)_0%,color-mix(in_srgb,var(--color-primary-soft)_46%,var(--color-surface))_100%)] p-3.5 shadow-[0_1px_0_rgb(15_23_42_/_0.04)] max-[767px]:rounded-none max-[767px]:border-x-0 max-[767px]:border-t-0 max-[767px]:shadow-none max-[479px]:min-h-[58px] max-[479px]:grid-cols-[28px_minmax(0,1fr)] [&_.icon]:text-(--color-primary) [&>span]:text-xs [&>span]:font-bold [&>span]:text-(--color-text-muted) [&>strong]:text-2xl [&>strong]:font-extrabold [&>strong]:leading-[30px] [&>strong]:text-(--color-text) [&>strong]:tabular-nums max-[479px]:[&>strong]:col-start-2 max-[479px]:[&>strong]:justify-self-start max-[479px]:[&>strong]:text-xl max-[479px]:[&>strong]:leading-6";
...
const memberCommandBarClassName = "member-command-bar grid min-w-0 gap-3 rounded-(--radius-lg) border border-[color-mix(in_srgb,var(--color-primary-border)_52%,var(--color-border))] bg-[linear-gradient(135deg,rgb(255_255_255)_0%,color-mix(in_srgb,var(--color-route-soft)_56%,var(--color-surface))_100%)] p-4 shadow-[0_1px_0_rgb(15_23_42_/_0.04)] max-[1199px]:grid-cols-1 max-[767px]:rounded-none max-[767px]:border-x-0 max-[767px]:border-t-0 max-[767px]:p-3 max-[767px]:shadow-none";
