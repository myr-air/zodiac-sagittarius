...
const routeMapLayoutClassName = "route-map-layout mb-7 block h-full min-h-0 w-full rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface) p-2 shadow-[0_10px_22px_rgb(55_47_38_/_0.045)] max-[1199px]:w-full max-[1199px]:px-2 max-[767px]:mb-2 max-[767px]:p-1.5";
const routeMapCanvasClassName = "route-map-canvas relative h-full min-h-[560px] overflow-hidden rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface-subtle) max-[767px]:h-[58vh] max-[767px]:min-h-[390px]";
const mapDayFilterClassName = "map-day-filter absolute left-3 top-3 z-[8] flex max-w-[min(760px,calc(100%_-_104px))] flex-wrap gap-2 rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface) p-1.5 shadow-[0_8px_16px_rgb(55_47_38_/_0.05)] max-[767px]:left-2 max-[767px]:right-2 max-[767px]:max-w-none";
const mapDayFilterButtonClassName = "map-day-filter-button inline-flex min-h-8 items-center gap-1.5 rounded-full border border-(--color-border) bg-(--color-surface) px-2.5 py-1.5 text-[11px] font-extrabold leading-4 text-(--color-text-muted) transition-[background,border-color,color,box-shadow] duration-150 hover:border-[var(--day-color,var(--color-route))] hover:bg-(--color-route-soft) hover:text-(--color-text) focus-visible:border-[var(--day-color,var(--color-route))] focus-visible:bg-(--color-route-soft) focus-visible:text-(--color-text)";
const activeMapDayFilterButtonClassName = "map-day-filter-button--active border-[var(--day-color,var(--color-primary))] bg-(--color-primary-soft) text-[#172033] shadow-[0_10px_22px_rgb(194_79_22_/_0.14)]";
...
const routeMapStatusClassName = "route-map-status absolute left-1/2 top-1/2 z-[7] m-0 grid min-w-[220px] -translate-x-1/2 -translate-y-1/2 gap-1 rounded-(--radius-md) border border-(--color-route-border) bg-(--color-surface) px-3 py-2.5 text-xs font-extrabold text-[#0369a1] shadow-[0_10px_22px_rgb(37_99_235_/_0.1)]";
const routeMapFallbackClassName = "route-map-fallback absolute inset-0 z-[2]";
const routeMapRetryButtonClassName = "route-map-retry mt-2 inline-flex min-h-9 items-center gap-1.5 rounded-(--radius-sm) border border-(--color-route-border) bg-(--color-surface) px-3 py-1.5 text-xs font-extrabold text-[#075985] transition-[background,border-color,box-shadow] duration-150 hover:bg-(--color-route-soft) focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--color-primary) [&_.icon]:size-3.5";
const mapZoneClassName = "map-zone absolute z-[1] rounded-full border border-(--color-border) bg-(--color-surface) px-2 py-1 text-[11px] font-extrabold uppercase leading-[15px] text-[#334155] shadow-[0_6px_12px_rgb(15_23_42_/_0.06)]";
...
const routeStopListClassName = "route-stop-list absolute right-3 top-[78px] z-[6] grid max-h-[min(292px,52%)] w-[min(282px,calc(100%_-_24px))] gap-1.5 overflow-y-auto rounded-(--radius-md) border border-(--color-route-border) bg-(--color-surface) p-2.5 text-[11px] font-bold leading-4 text-[#475569] shadow-[0_10px_22px_rgb(37_99_235_/_0.08)] max-[767px]:hidden";
...
const mapSourceNoteClassName = "map-source-note absolute bottom-2 right-2.5 z-[6] m-0 rounded-full border border-(--color-route-border) bg-(--color-surface) px-2 py-1 text-[10px] font-extrabold leading-[14px] text-[#0369a1]";
const unresolvedPanelClassName = "map-unresolved-panel absolute bottom-10 left-3 z-[7] grid max-h-[min(220px,42%)] w-[min(380px,calc(100%_-_24px))] gap-2 overflow-hidden rounded-(--radius-md) border border-(--color-warning-border) bg-(--color-warning-soft) p-3 text-[#9a3412] shadow-[0_10px_22px_rgb(249_115_22_/_0.08)]";
...
const unresolvedPanelItemClassName = "map-unresolved-item grid gap-0.5 rounded-(--radius-sm) bg-(--color-surface) px-2 py-1.5 text-[11px] leading-4 text-[#9a3412]";
