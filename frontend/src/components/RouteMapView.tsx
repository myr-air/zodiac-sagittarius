...
const activeMapDayFilterButtonClassName = "map-day-filter-button--active border-[var(--day-color,var(--color-primary))] bg-(--color-primary-soft) text-(--color-text) shadow-[0_10px_22px_rgb(194_79_22_/_0.14)]";
...
const routeMapStatusClassName = "route-map-status absolute left-1/2 top-1/2 z-[7] m-0 grid min-w-[220px] -translate-x-1/2 -translate-y-1/2 gap-1 rounded-(--radius-md) border border-(--color-route-border) bg-(--color-surface) px-3 py-2.5 text-xs font-extrabold text-(--color-route) shadow-[0_10px_22px_rgb(37_99_235_/_0.1)]";
...
const mapZoneClassName = "map-zone absolute z-[1] rounded-full border border-(--color-border) bg-(--color-surface) px-2 py-1 text-[11px] font-extrabold uppercase leading-[15px] text-(--color-text-muted) shadow-[0_6px_12px_rgb(15_23_42_/_0.06)]";
...
const routeStopListClassName = "route-stop-list absolute right-3 top-[78px] z-[6] grid max-h-[min(292px,52%)] w-[min(282px,calc(100%_-_24px))] gap-1.5 overflow-y-auto rounded-(--radius-md) border border-(--color-route-border) bg-(--color-surface) p-2.5 text-[11px] font-bold leading-4 text-(--color-text-muted) shadow-[0_10px_22px_rgb(37_99_235_/_0.08)] max-[767px]:hidden";
...
const mapSourceNoteClassName = "map-source-note absolute bottom-2 right-2.5 z-[6] m-0 rounded-full border border-(--color-route-border) bg-(--color-surface) px-2 py-1 text-[10px] font-extrabold leading-[14px] text-(--color-route)";
const unresolvedPanelClassName = "map-unresolved-panel absolute bottom-10 left-3 z-[7] grid max-h-[min(220px,42%)] w-[min(380px,calc(100%_-_24px))] gap-2 overflow-hidden rounded-(--radius-md) border border-(--color-warning-border) bg-(--color-warning-soft) p-3 text-(--color-warning-strong) shadow-[0_10px_22px_rgb(249_115_22_/_0.08)]";
