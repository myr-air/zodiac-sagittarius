...
const routeMapPanelClassName = "route-map-panel grid h-full min-h-0 min-w-0 grid-rows-[auto_minmax(0,1fr)] bg-transparent px-6 py-[22px] pb-7 max-[767px]:px-0 max-[767px]:py-0 max-[767px]:pb-0 max-[767px]:[&_.page-header]:mb-0 max-[767px]:[&_.page-header]:rounded-none max-[767px]:[&_.page-header]:border-x-0 max-[767px]:[&_.page-header]:border-t-0 max-[767px]:[&_.page-header]:shadow-none";
const routeMapLayoutClassName = "route-map-layout mb-7 block h-full min-h-0 w-full rounded-(--radius-lg) border border-[color-mix(in_srgb,var(--color-route)_18%,var(--color-border))] bg-[linear-gradient(135deg,var(--color-surface)_0%,var(--color-route-soft)_100%)] p-2 shadow-[0_1px_0_rgb(15_23_42_/_0.04)] max-[1199px]:w-full max-[1199px]:px-2 max-[767px]:mb-0 max-[767px]:rounded-none max-[767px]:border-0 max-[767px]:bg-transparent max-[767px]:p-0 max-[767px]:shadow-none";
const routeMapCanvasClassName = "route-map-canvas relative h-full min-h-[560px] overflow-hidden rounded-(--radius-lg) border border-[color-mix(in_srgb,var(--color-route)_18%,var(--color-border))] bg-[linear-gradient(135deg,var(--color-surface)_0%,var(--color-route-soft)_100%)] max-[767px]:h-[min(68dvh,620px)] max-[767px]:min-h-[440px] max-[767px]:rounded-none max-[767px]:border-x-0";
const mapDayFilterClassName = "map-day-filter absolute left-3 top-3 z-[8] flex max-w-[min(760px,calc(100%_-_104px))] flex-wrap gap-2 rounded-(--radius-lg) border border-[color-mix(in_srgb,var(--color-route)_18%,white)] bg-[rgb(255_255_255_/_0.86)] p-1.5 shadow-[0_1px_0_rgb(15_23_42_/_0.04)] max-[767px]:left-2 max-[767px]:right-auto max-[767px]:top-2 max-[767px]:w-[calc(100%_-_96px)] max-[767px]:max-w-[calc(100%_-_96px)] max-[767px]:flex-nowrap max-[767px]:gap-1 max-[767px]:overflow-x-auto max-[767px]:rounded-full max-[767px]:p-1";
const mapDayFilterButtonClassName = "map-day-filter-button inline-flex min-h-8 shrink-0 items-center gap-1.5 rounded-full border border-[color-mix(in_srgb,var(--color-route)_14%,var(--color-border))] bg-[rgb(255_255_255_/_0.78)] px-2.5 py-1.5 text-[11px] font-extrabold leading-4 text-(--color-text-muted) transition-[background,border-color,color,box-shadow] duration-150 hover:border-[var(--day-color,var(--color-route))] hover:bg-(--color-route-soft) hover:text-(--color-text) focus-visible:border-[var(--day-color,var(--color-route))] focus-visible:bg-(--color-route-soft) focus-visible:text-(--color-text) max-[767px]:min-h-7 max-[767px]:px-2 max-[767px]:py-1";
...
const unresolvedPanelClassName = "map-unresolved-panel absolute bottom-10 left-3 z-[7] grid max-h-[min(220px,42%)] w-[min(380px,calc(100%_-_24px))] gap-2 overflow-hidden rounded-(--radius-md) border border-(--color-warning-border) bg-[linear-gradient(135deg,var(--color-surface)_0%,var(--color-warning-soft)_100%)] p-3 text-(--color-warning-strong) shadow-[0_4px_8px_rgb(249_115_22_/_0.08)] max-[767px]:bottom-2 max-[767px]:left-2 max-[767px]:right-2 max-[767px]:max-h-none max-[767px]:w-auto max-[767px]:gap-1 max-[767px]:rounded-(--radius-sm) max-[767px]:p-2 max-[767px]:shadow-[0_1px_0_rgb(15_23_42_/_0.04)]";
