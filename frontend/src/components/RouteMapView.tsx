...
const routeMapPanelClassName = "route-map-panel grid h-full min-h-0 min-w-0 grid-rows-[auto_minmax(0,1fr)] bg-transparent px-6 py-[22px] pb-7 max-[767px]:h-[calc(100dvh-48px)] max-[767px]:min-h-[calc(100dvh-48px)] max-[767px]:overflow-hidden max-[767px]:px-0 max-[767px]:py-0 max-[767px]:pb-0 max-[767px]:[&_.page-header]:mb-0 max-[767px]:[&_.page-header]:min-h-0 max-[767px]:[&_.page-header]:rounded-none max-[767px]:[&_.page-header]:border-x-0 max-[767px]:[&_.page-header]:border-t-0 max-[767px]:[&_.page-header]:px-3 max-[767px]:[&_.page-header]:py-2 max-[767px]:[&_.page-header]:shadow-none max-[767px]:[&_.page-header-copy]:gap-0.5 max-[767px]:[&_.page-header-meta]:mt-1 max-[767px]:[&_.page-header-meta]:flex-nowrap max-[767px]:[&_.page-header-meta]:gap-1.5 max-[767px]:[&_.page-header-meta]:overflow-x-auto max-[767px]:[&_.page-header-meta]:pb-0.5 max-[767px]:[&_.page-header-meta]:[scrollbar-width:none] max-[767px]:[&_.page-header-meta::-webkit-scrollbar]:hidden max-[767px]:[&_.page-header-meta>span]:min-h-6 max-[767px]:[&_.page-header-meta>span]:shrink-0 max-[767px]:[&_.page-header-meta>span]:px-2 max-[767px]:[&_.page-header-meta>span]:text-[10px] max-[767px]:[&_h1]:text-[18px] max-[767px]:[&_h1]:leading-6 max-[767px]:[&_h2]:truncate max-[767px]:[&_h2]:text-[12px] max-[767px]:[&_h2]:leading-4";
...
const routeMapCanvasClassName = "route-map-canvas relative h-full min-h-[560px] overflow-hidden rounded-(--radius-lg) border border-[color-mix(in_srgb,var(--color-route)_18%,var(--color-border))] bg-[linear-gradient(135deg,var(--color-surface)_0%,var(--color-route-soft)_100%)] max-[767px]:h-[calc(100dvh-48px)] max-[767px]:min-h-0 max-[767px]:rounded-none max-[767px]:border-x-0 max-[767px]:border-b-0";
