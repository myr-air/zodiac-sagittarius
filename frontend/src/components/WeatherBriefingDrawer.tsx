...
const textAreaClassName = "min-h-16 rounded-[var(--radius-sm)] border border-[var(--color-border)] bg-white p-2 text-sm font-bold text-[var(--color-text)]";
...
function OrganizerOverrideForm({
  ...
  return (
    <form className={briefingBlockClassName} onSubmit={submitOverrides}>
      ...
      <label className="grid gap-1 text-xs font-extrabold text-[var(--color-text-muted)]">
