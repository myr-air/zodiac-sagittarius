...
const filePanelClassName = "bookings-file-panel grid min-h-0 grid-rows-[auto_auto_minmax(0,1fr)] rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface) shadow-[0_1px_0_rgb(15_23_42_/_0.04)] max-[767px]:grid-rows-[auto_auto_minmax(360px,1fr)] max-[767px]:rounded-none max-[767px]:border-x-0 max-[767px]:border-t-0 max-[767px]:shadow-none";
const fileToolbarClassName = "bookings-file-toolbar grid gap-2 border-b border-(--color-border) p-3 max-[767px]:gap-1 max-[767px]:p-1.5";
...
const activeFolderBarClassName = "flex flex-wrap items-center justify-between gap-2 border-b border-(--color-border) px-3 py-2 max-[767px]:px-2 max-[767px]:py-1";
...
const fileHeaderClassName = "grid min-w-[840px] grid-cols-[minmax(240px,1.7fr)_96px_110px_minmax(130px,1fr)_116px_92px] items-center gap-3 border-b border-(--color-border) bg-(--color-surface-subtle) px-3 py-2 text-[11px] font-black text-(--color-text-muted) max-[767px]:min-w-[760px] max-[767px]:gap-2 max-[767px]:px-2";
const fileRowClassName = "booking-file-row grid min-w-[840px] grid-cols-[minmax(240px,1.7fr)_96px_110px_minmax(130px,1fr)_116px_92px] items-center gap-3 border-b border-(--color-border) px-3 py-2.5 text-left text-sm transition-colors hover:bg-(--color-surface-subtle) focus-within:bg-(--color-primary-soft) max-[767px]:min-w-[760px] max-[767px]:gap-2 max-[767px]:px-2";
