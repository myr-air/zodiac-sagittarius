...
const brandRowClassName = "brand-row inline-flex min-h-[70px] items-center justify-between px-4 pl-5 data-[collapsed=true]:px-[7px] data-[collapsed=true]:pl-2 max-[1199px]:px-[7px] max-[1199px]:pl-2 max-[767px]:min-h-[48px] max-[767px]:border-b max-[767px]:border-(--color-border) max-[767px]:px-3 max-[767px]:pl-3";
