...
const railToggleClassName = "rail-toggle inline-flex min-h-[34px] w-[34px] items-center justify-center border-0 bg-transparent text-(--color-text-muted) transition-[color,background] duration-150 hover:bg-(--color-primary-soft) hover:text-(--color-primary) data-[collapsed=true]:min-h-7 data-[collapsed=true]:w-7 data-[collapsed=true]:rounded-(--radius-sm) data-[collapsed=true]:border data-[collapsed=true]:border-(--color-border) data-[collapsed=true]:bg-(--color-surface) data-[collapsed=true]:[&_.icon]:size-4 max-[1199px]:min-h-7 max-[1199px]:w-7";
