...
const sideRailLanguageClassName = "side-rail-language mx-3.5 mb-1 mt-2 self-start data-[collapsed=true]:mx-0 data-[collapsed=true]:flex-col data-[collapsed=true]:self-center data-[collapsed=true]:[&_.language-switch-option]:min-w-9 data-[collapsed=true]:[&_.language-switch-option]:px-0 max-[1199px]:mx-0 max-[1199px]:flex-col max-[1199px]:self-center max-[1199px]:[&_.language-switch-option]:min-w-9 max-[1199px]:[&_.language-switch-option]:px-0 max-[767px]:flex-row max-[767px]:[&_.language-switch-option]:min-w-11";
