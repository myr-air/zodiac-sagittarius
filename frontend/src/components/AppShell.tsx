...
const brandMarkClassName = "brand-mark grid size-[34px] place-items-center rounded-full bg-(--color-primary) text-white font-extrabold shadow-[0_10px_20px_rgb(255_119_61_/_0.24)] [&_.icon]:size-[19px] [&_.icon]:stroke-[2.4]";
...
const activeRailLinkClassName = "rail-link--active bg-(--color-surface-muted) text-(--color-text) shadow-[inset_0_0_0_1px_rgb(255_255_255_/_0.72)] before:absolute before:left-[-9px] before:h-7 before:w-[3px] before:rounded-full before:bg-(--color-primary) before:content-['']";
...
const memberCardBaseClassName = "member-card mx-3 mb-5 rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface-subtle) p-[11px] data-[collapsed=true]:mx-2 data-[collapsed=true]:flex data-[collapsed=true]:min-h-[54px] data-[collapsed=true]:justify-center data-[collapsed=true]:p-2 max-[1199px]:mx-2 max-[1199px]:flex max-[1199px]:min-h-[54px] max-[1199px]:justify-center max-[1199px]:p-2 max-[767px]:hidden";
