...
export const workspaceCopyFeedbackStatusClassName =
  "data-[state=copied]:border-(--color-success-border) data-[state=copied]:bg-(--color-success-soft) data-[state=copied]:text-(--color-success-strong) data-[state=error]:border-(--color-danger-border) data-[state=error]:bg-(--color-danger-soft) data-[state=error]:text-[#b91c1c]";

export const workspaceCopyFeedbackTextStatusClassName =
  "data-[state=copied]:text-(--color-success-strong) data-[state=error]:text-[#b91c1c]";
