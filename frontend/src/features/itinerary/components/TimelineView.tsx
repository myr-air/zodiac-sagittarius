...
const timelinePanelClassName = "timeline-panel grid min-h-full min-w-0 grid-rows-[auto_minmax(0,1fr)] gap-3 bg-transparent px-6 py-[22px] pb-7 max-[1199px]:min-h-[calc(100dvh-48px)] max-[1199px]:gap-0 max-[1199px]:px-0 max-[1199px]:py-0 max-[1199px]:pb-0 max-[767px]:h-[calc(100dvh-48px)] max-[767px]:overflow-hidden";
const timelineGridClassName = "timeline-grid mb-[30px] grid w-full grid-cols-3 gap-3 p-0 max-[1199px]:mb-0 max-[1199px]:grid-cols-1 max-[1199px]:gap-0 max-[767px]:overflow-y-auto";
...
const selectedTimelineStopButtonClassName = "bg-(--color-primary-soft) shadow-[inset_0_0_0_1px_var(--color-primary-border),inset_3px_0_0_var(--color-primary)]";
const timelineTimeClassName = "timeline-time col-start-1 row-span-3 grid min-w-0 gap-0.5 [&_span]:text-[11px] [&_span]:font-bold [&_span]:leading-[15px] [&_span]:tabular-nums [&_span]:text-(--color-text-muted) [&_strong]:text-[13px] [&_strong]:font-extrabold [&_strong]:leading-[18px] [&_strong]:tabular-nums [&_strong]:text-(--color-text)";
const timelineNodeClassName = "timeline-node col-start-2 row-start-1 grid size-8 place-items-center rounded-full border-2 border-white bg-(--color-primary-soft) text-(--color-primary-strong) shadow-[0_1px_0_rgb(15_23_42_/_0.06)]";
...
const timelineWarningClassName = "timeline-warning col-start-3 row-start-3 inline-flex min-h-6 w-fit items-center gap-1.5 rounded-(--radius-sm) border border-(--color-warning-border) bg-(--color-warning-soft) px-2 py-0.5 text-[11px] font-extrabold leading-[15px] text-(--color-warning-strong)";
const detailsToggleButtonClassName = "details-toggle-button aria-[expanded=false]:border-(--color-primary-border) aria-[expanded=false]:bg-(--color-primary-soft) aria-[expanded=false]:text-(--color-primary-strong)";
