...
export const overviewTaskListClassName =
  "overview-task-list m-0 grid list-none gap-2 p-0 text-[13px] font-semibold leading-5 text-(--color-text-muted) max-[767px]:[&_li:nth-child(n+2)]:hidden";
...
export const overviewHeroRoleClassName = "overview-hero-role m-0 max-w-[620px] text-[15px] font-bold leading-[23px] text-[color-mix(in_srgb,var(--overview-hero-ink)_78%,var(--color-text-muted))] max-[767px]:text-[13px] max-[767px]:leading-5 max-[767px]:hidden";
export const overviewHeroMetaClassName = "overview-hero-meta mt-0.5 flex flex-wrap gap-1.5 max-[767px]:grid max-[767px]:grid-cols-2 max-[767px]:gap-1.5 [&_.icon]:text-(--overview-hero-accent) [&_span]:inline-flex [&_span]:min-h-8 [&_span]:min-w-0 [&_span]:max-w-full [&_span]:items-center [&_span]:gap-[7px] [&_span]:rounded-(--radius-sm) [&_span]:border [&_span]:border-[color-mix(in_srgb,var(--overview-hero-accent)_16%,var(--color-border))] [&_span]:bg-[rgb(255_255_255_/_0.78)] [&_span]:px-[9px] [&_span]:py-1.5 [&_span]:text-xs [&_span]:font-extrabold [&_span]:leading-4 [&_span]:text-(--color-text) max-[767px]:[&_span:nth-child(n+3)]:hidden max-[767px]:[&_span]:gap-1.5 max-[767px]:[&_span]:overflow-hidden max-[767px]:[&_span]:text-ellipsis max-[767px]:[&_span]:whitespace-nowrap max-[767px]:[&_span]:px-2 max-[767px]:[&_span]:text-[11px]";
export const overviewHeroAsideClassName =
  "overview-hero-aside relative z-[2] grid min-w-0 content-center gap-2 self-center rounded-(--radius-md) border border-[color-mix(in_srgb,var(--overview-hero-accent)_14%,var(--color-border))] bg-[rgb(255_255_255_/_0.76)] p-2.5 shadow-[inset_0_1px_0_rgb(255_255_255_/_0.78)] max-[1199px]:col-auto max-[1199px]:grid-cols-1 max-[1199px]:items-center max-[1199px]:rounded-none max-[1199px]:border-0 max-[1199px]:bg-transparent max-[1199px]:p-0 max-[1199px]:shadow-none max-[767px]:gap-0 [&_.page-current-user]:min-w-0 [&_.page-current-user]:w-full [&_.page-current-user]:border-transparent [&_.page-current-user]:bg-transparent [&_.page-current-user]:shadow-none max-[767px]:[&_.page-current-user]:hidden";
...
export const overviewHighlightBoardClassName =
  `overview-highlight-board col-span-12 min-w-0 max-w-full overflow-hidden rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface) p-3 shadow-[0_1px_0_rgb(15_23_42_/_0.04)] max-[1199px]:col-auto max-[1199px]:mb-0 ${workspaceResponsivePanelResetClassName} max-[767px]:rounded-none max-[767px]:border-0 max-[767px]:bg-transparent max-[767px]:p-0 max-[767px]:shadow-none`;
export const overviewBoardTitleClassName =
  "overview-board-title mb-2.5 flex items-center gap-[9px] text-(--color-text) max-[767px]:mb-2 max-[767px]:px-1 [&_.icon]:text-(--color-primary) [&_h2]:m-0 [&_h2]:text-[15px] [&_h2]:font-black [&_h2]:leading-[22px] [&_p]:m-0 [&_p]:text-xs [&_p]:font-bold [&_p]:leading-[17px] [&_p]:text-(--color-text-muted)";
...
export const tripCompletedClassName = "relative overflow-hidden rounded-(--radius-md) border border-(--color-warning-border) bg-(--color-warning-soft) bg-[image:var(--paper-grain)] bg-[length:120px_120px] p-5 max-[767px]:rounded-(--radius-lg) max-[767px]:p-3.5";
