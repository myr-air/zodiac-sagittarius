...
export const overviewHeroBaseClassName =
  "overview-hero relative col-span-7 row-span-2 grid min-h-[168px] min-w-0 max-w-full grid-cols-[minmax(0,1fr)_minmax(236px,280px)] items-center gap-4 overflow-hidden rounded-(--radius-lg) border border-[color-mix(in_srgb,var(--overview-hero-accent)_22%,var(--color-border))] bg-[linear-gradient(135deg,var(--color-surface)_0%,var(--overview-hero-sky)_100%)] p-5 shadow-[0_1px_0_rgb(15_23_42_/_0.04)] [--overview-hero-accent:var(--color-primary)] [--overview-hero-ground:#f7d9b8] [--overview-hero-horizon:#8bd3e6] [--overview-hero-ink:#18191f] [--overview-hero-sky:#eaf6ff] min-[1200px]:min-h-[268px] max-[1199px]:col-auto max-[1199px]:row-auto max-[1199px]:mb-0 max-[1199px]:grid-cols-1 max-[1199px]:gap-2 max-[1199px]:rounded-none max-[1199px]:border-x-0 max-[1199px]:border-t-0 max-[1199px]:p-4 max-[1199px]:shadow-none max-[767px]:min-h-0 max-[767px]:p-3";
...
export const cockpitCardBaseClassName =
  `overview-cockpit-card relative grid min-h-[126px] min-w-0 content-start gap-2 overflow-hidden rounded-(--radius-lg) border border-[color-mix(in_srgb,var(--overview-cockpit-accent)_16%,var(--color-border))] bg-[linear-gradient(150deg,var(--color-surface)_0%,var(--overview-cockpit-wash)_100%)] p-3.5 text-left text-inherit shadow-[inset_0_1px_0_rgb(255_255_255_/_0.72)] [--overview-cockpit-accent:var(--color-primary)] [--overview-cockpit-wash:var(--color-surface-subtle)] ${workspaceResponsivePanelResetClassName} max-[767px]:min-h-[104px] [&_small]:min-w-0 [&_small]:text-xs [&_small]:font-bold [&_small]:leading-[17px] [&_small]:text-(--color-text-muted) [&_strong]:min-w-0 [&_strong]:text-[22px] [&_strong]:font-black [&_strong]:leading-7 [&_strong]:text-(--color-text)`;
...
export const overviewHighlightBoardClassName =
  `overview-highlight-board col-span-5 min-w-0 max-w-full overflow-hidden rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface) p-3 shadow-[0_1px_0_rgb(15_23_42_/_0.04)] max-[1199px]:col-auto max-[1199px]:mb-0 ${workspaceResponsivePanelResetClassName}`;
...
export const overviewHighlightListClassName =
  "overview-highlight-list m-0 grid list-none grid-cols-2 gap-2.5 p-0 max-[1199px]:grid-cols-3 max-[767px]:flex max-[767px]:overflow-x-auto max-[767px]:overscroll-x-contain max-[767px]:pb-3.5 max-[767px]:snap-x max-[767px]:snap-mandatory max-[767px]:-mx-3 max-[767px]:px-3 [&::-webkit-scrollbar]:hidden";
