...
export const overviewHeroTitleClassName = "m-0 text-[28px] font-[900] leading-[34px] text-(--overview-hero-ink) max-[767px]:text-xl max-[767px]:leading-6";
