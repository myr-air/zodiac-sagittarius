...
const routeMapPanelClassName = "route-map-panel grid h-full min-h-0 min-w-0 grid-rows-[auto_minmax(0,1fr)] bg-transparent px-6 py-[22px] pb-7 max-[1199px]:h-auto max-[1199px]:min-h-[calc(100dvh-48px)] max-[1199px]:px-0 max-[1199px]:py-0 max-[1199px]:pb-0 max-[767px]:h-[calc(100dvh-48px)] max-[767px]:overflow-hidden max-[767px]:[&_.page-header]:mb-0 max-[767px]:[&_.page-header]:min-h-0 max-[767px]:[&_.page-header]:px-3 max-[767px]:[&_.page-header]:py-2 max-[767px]:[&_.page-header-copy]:gap-0.5 max-[767px]:[&_.page-header-meta]:mt-1 max-[767px]:[&_.page-header-meta]:flex-nowrap max-[767px]:[&_.page-header-meta]:gap-1.5 max-[767px]:[&_.page-header-meta]:overflow-x-auto max-[767px]:[&_.page-header-meta]:pb-0.5 max-[767px]:[&_.page-header-meta]:[scrollbar-width:none] max-[767px]:[&_.page-header-meta::-webkit-scrollbar]:hidden max-[767px]:[&_.page-header-meta>span]:min-h-6 max-[767px]:[&_.page-header-meta>span]:shrink-0 max-[767px]:[&_.page-header-meta>span]:px-2 max-[767px]:[&_.page-header-meta>span]:text-[10px] max-[767px]:[&_h1]:text-[18px] max-[767px]:[&_h1]:leading-6 max-[767px]:[&_h2]:truncate max-[767px]:[&_h2]:text-[12px] max-[767px]:[&_h2]:leading-4";
const routeMapLayoutClassName = "route-map-layout mb-7 block h-full min-h-0 w-full rounded-(--radius-lg) border border-[color-mix(in_srgb,var(--color-route)_18%,var(--color-border))] bg-[linear-gradient(135deg,var(--color-surface)_0%,var(--color-route-soft)_100%)] p-2 shadow-[0_1px_0_rgb(15_23_42_/_0.04)] max-[1199px]:mb-0 max-[1199px]:w-full max-[1199px]:rounded-none max-[1199px]:border-0 max-[1199px]:bg-transparent max-[1199px]:p-0 max-[1199px]:shadow-none";
const routeMapCanvasClassName = "route-map-canvas relative h-full min-h-[560px] overflow-hidden rounded-(--radius-lg) border border-[color-mix(in_srgb,var(--color-route)_18%,var(--color-border))] bg-[linear-gradient(135deg,var(--color-surface)_0%,var(--color-route-soft)_100%)] max-[1199px]:min-h-[calc(100dvh-168px)] max-[1199px]:rounded-none max-[1199px]:border-x-0 max-[1199px]:border-b-0 max-[767px]:h-[calc(100dvh-48px)] max-[767px]:min-h-0";
