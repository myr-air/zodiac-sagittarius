export const graphColumnMinWidth = 30;
export const graphColumnSidePadding = 9;
export const graphColumnLaneGap = 18;
export const dayTitleMaxLength = 48;
export const dayTitleMinWidthCh = 12;
export const dayGroupClassName = "day-group";
...
export const dayOrdinalClassName =
  "day-ordinal shrink-0 text-sm font-extrabold text-(--color-text)";
export const dayTitleInputClassName =
...
export const dayClearPathButtonClassName =
...
export const itemPlaceholderRowClassName =
