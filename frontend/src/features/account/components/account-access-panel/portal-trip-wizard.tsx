...
import { Badge, Button, FloatingActionButton, SwapButton } from "@/src/ui";
    ...
    <form className={cn(wizardStyles.accountSettingsFormClassName, wizardStyles.portalCreateTripInlineClassName)} aria-label={wizard.title} onSubmit={submitWizard}>
      ...
      <div className={wizardStyles.tripWizardLayoutClassName}>
        ...
        <aside className={cn(wizardStyles.tripLivePreviewClassName, isMobilePreviewStep ? "" : "max-[767px]:hidden")} role="region" aria-label="Live trip preview">
          <section className={mobileStepClassName("preview", "trip-preview-step grid")} role="region" aria-label={tripWizardSteps[4].regionLabel} data-mobile-active={activeMobileStep === "preview" ? "true" : "false"}>
              ...
              <div className={wizardStyles.tripMainTicketClassName}>
                ...
                <div className={wizardStyles.tripPreviewDestinationRowClassName}>
                  ...
                  <div>
                    ...
                    <FloatingActionButton className={cn(wizardStyles.tripMiniAddClassName, "static")} type="button" onClick={focusDestinationSearch}>
                      <Icon name="plus" />
