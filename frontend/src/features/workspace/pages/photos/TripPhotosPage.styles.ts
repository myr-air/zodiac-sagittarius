...
export const providerGridClassName = "photos-providers flex flex-wrap items-center gap-1.5 max-h-[78px] overflow-hidden max-[767px]:max-h-none max-[767px]:flex-nowrap max-[767px]:overflow-x-auto max-[767px]:pb-1 max-[767px]:[mask-image:linear-gradient(to_right,black_85%,transparent_100%)] max-[767px]:[scrollbar-width:none] max-[767px]:[&::-webkit-scrollbar]:hidden";
...
export const dialogFormClassName = "grid min-h-0 grid-rows-[minmax(0,1fr)_auto] overflow-hidden";
export const dialogBodyClassName = `${workspaceDialogFormClassName} min-h-0`;
export const dialogGridClassName = workspaceDialogGridClassName;
export const fieldClassName = workspaceFieldClassName;
export const dialogActionsClassName = `${workspaceDialogActionsClassName} bg-(--color-surface) px-4 pb-4 pt-3`;
