...
export const impactLineClassName =
  "trip-settings-impact-row grid grid-cols-[20px_minmax(0,1fr)] items-start gap-x-2 rounded-(--radius-md) border border-(--color-border) bg-(--color-surface-subtle) p-3 text-[13px] leading-5 text-(--color-text-muted) [&_.icon]:mt-0.5 [&_.icon]:size-4 [&_.icon]:text-(--color-primary-strong)";
