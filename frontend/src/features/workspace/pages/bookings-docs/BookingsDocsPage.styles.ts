...
export const folderRailClassName = "booking-folder-rail grid min-h-0 content-start gap-1 shadow-none max-[1199px]:flex max-[1199px]:content-normal max-[1199px]:gap-1 max-[1199px]:overflow-x-auto max-[1199px]:p-2 max-[1199px]:[mask-image:linear-gradient(to_right,black_90%,transparent_100%)] max-[1199px]:[scrollbar-width:none] max-[1199px]:[&::-webkit-scrollbar]:hidden max-[767px]:rounded-none max-[767px]:shadow-none";
export const folderButtonClassName = "group grid min-h-10 grid-cols-[28px_minmax(0,1fr)_auto] items-center gap-2 rounded-(--radius-md) border border-transparent bg-transparent px-2 py-1.5 text-left text-sm font-bold text-(--color-text-muted) transition-[background-color,border-color,color] duration-150 hover:bg-(--color-surface-subtle) hover:text-(--color-text) focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--color-primary) [&_.icon]:size-4 max-[1199px]:min-h-11 max-[1199px]:min-w-[128px] max-[1199px]:shrink-0 max-[1199px]:grid-cols-[22px_minmax(0,1fr)_auto] max-[1199px]:gap-1.5 max-[1199px]:rounded-(--radius-md) max-[1199px]:border max-[1199px]:border-(--color-border) max-[1199px]:bg-(--color-surface) max-[1199px]:px-2 max-[1199px]:py-1.5 max-[1199px]:text-left max-[767px]:min-w-[118px]";
export const selectedFolderClassName = "border-(--color-primary-border) bg-(--color-primary-soft) text-(--color-primary-strong) max-[1199px]:border-(--color-primary-border) max-[1199px]:bg-(--color-primary-soft)";
...
export const fileToolbarClassName = "bookings-file-toolbar grid gap-2 border-b border-(--color-border) p-3 max-[1199px]:px-3 max-[1199px]:py-2 max-[767px]:gap-1.5 max-[767px]:px-2 max-[767px]:py-2";
export const toolbarControlsClassName = "grid grid-cols-[minmax(0,1fr)_176px] items-center gap-2 max-[767px]:grid-cols-1 max-[767px]:gap-1.5";
...
export const fileHeaderClassName = "sticky top-0 z-[1] grid min-w-[760px] grid-cols-[minmax(220px,1.7fr)_110px_100px_minmax(120px,1fr)_108px_70px] items-center gap-2 border-b border-(--color-border) bg-(--color-surface-subtle) px-3 py-2 text-[11px] font-black text-(--color-text-muted) max-[1199px]:hidden";
export const fileRowClassName = "booking-file-row booking-ticket-card grid min-w-[760px] grid-cols-[minmax(220px,1.7fr)_110px_100px_minmax(120px,1fr)_108px_70px] items-center gap-2 border-b border-(--color-border) px-3 py-2.5 text-left text-sm transition-colors hover:bg-(--color-surface-subtle) focus-within:bg-(--color-primary-soft) max-[1199px]:min-w-0 max-[1199px]:grid-cols-[minmax(0,1fr)_auto] max-[1199px]:gap-x-3 max-[1199px]:gap-y-1 max-[1199px]:px-3 max-[1199px]:py-3";
...
export const badgeClassName = `${workspaceBadgeFrameClassName} whitespace-nowrap`;
