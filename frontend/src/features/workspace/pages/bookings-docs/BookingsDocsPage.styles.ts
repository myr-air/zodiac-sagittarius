...
export const folderRailClassName = "booking-folder-rail grid min-h-0 content-start gap-1 shadow-none max-[1199px]:flex max-[1199px]:content-normal max-[1199px]:gap-1 max-[1199px]:overflow-x-auto max-[1199px]:p-2 max-[1199px]:[scrollbar-width:none] max-[1199px]:[&::-webkit-scrollbar]:hidden max-[767px]:rounded-none max-[767px]:shadow-none";
