...
export const membersPageClassName = "members-page grid-rows-[auto_auto_auto_minmax(0,1fr)] max-[767px]:p-4";
export const memberStatGridClassName = "member-stat-grid flex flex-wrap gap-3 max-[767px]:flex-nowrap max-[767px]:snap-x max-[767px]:overflow-x-auto max-[767px]:pb-1 max-[767px]:[scrollbar-width:none] max-[767px]:[&::-webkit-scrollbar]:hidden";
export const memberStatClassName = "member-stat flex-[1_1_160px] min-w-[160px] grid min-h-14 grid-cols-[24px_minmax(0,1fr)] items-center gap-x-2 rounded-(--radius-md) border border-(--color-border) bg-(--color-surface) px-3 py-2 text-left shadow-none max-[767px]:min-w-[116px] max-[767px]:flex-[0_0_auto] max-[767px]:snap-start max-[767px]:grid-cols-[20px_minmax(0,1fr)] max-[767px]:px-2.5 max-[767px]:py-1.5 [&_.icon]:row-span-2 [&_.icon]:text-(--color-primary) [&>span]:text-[11px] [&>span]:font-bold [&>span]:leading-4 [&>span]:text-(--color-text-muted) [&>strong]:text-sm [&>strong]:font-black [&>strong]:leading-5 [&>strong]:tabular-nums [&>strong]:text-(--color-text)";
export const memberCommandBarClassName = `member-command-bar flex min-w-0 flex-wrap items-start gap-2 rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface) p-3 shadow-none max-[767px]:gap-1.5 max-[767px]:p-2.5 ${workspaceResponsivePanelResetClassName}`;
export const memberCommandFieldsClassName = cn("member-command-fields flex min-w-0 flex-1 flex-wrap items-end gap-2 [&>label]:min-w-0 [&>label]:flex-[1_1_220px]", workspaceCompactFieldGroupClassName);
export const memberCommandActionsClassName = "member-command-actions flex min-w-0 flex-wrap items-center justify-end gap-2 max-[1199px]:justify-start max-[767px]:[&>*]:min-h-9 max-[767px]:[&>*]:px-2 max-[767px]:[&>*]:text-xs";
export const memberCommandMetaClassName = "member-command-meta w-full grid min-w-0 grid-cols-[minmax(0,1fr)_auto] items-center gap-2 max-[1199px]:grid-cols-1 max-[767px]:rounded-(--radius-md) max-[767px]:border max-[767px]:border-(--color-border) max-[767px]:bg-(--color-surface-subtle) max-[767px]:p-2 [&_code]:overflow-hidden [&_code]:rounded-(--radius-sm) [&_code]:border [&_code]:border-(--color-border) [&_code]:bg-(--color-surface-muted) [&_code]:px-[9px] [&_code]:py-[7px] [&_code]:text-xs [&_code]:text-(--color-text-muted) [&_code]:text-ellipsis [&_code]:whitespace-nowrap max-[767px]:[&_code]:py-1.5 max-[767px]:[&_code]:text-[11px]";
...
export const memberFilterInputClassName = "focus:border-(--color-primary-border) focus:shadow-[0_0_0_3px_var(--color-primary-soft)]";
