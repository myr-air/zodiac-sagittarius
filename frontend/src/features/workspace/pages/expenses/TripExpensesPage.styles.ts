...
export const transactionDetailActionsClassName = "grid gap-2 rounded-(--radius-md) border border-(--color-border) bg-(--color-surface) p-2 [&_button]:min-h-10 [&_button]:justify-start max-[767px]:sticky max-[767px]:bottom-0 max-[767px]:z-[1]";
