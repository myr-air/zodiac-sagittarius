...
export const personalStatementMobileListClassName = "hidden gap-2.5 p-3 max-[767px]:grid";
...
export const personalStatementMobileMetaClassName = "grid gap-1.5 border-t border-(--color-border) pt-2 text-xs font-bold text-(--color-text-muted) [&_div]:grid [&_div]:grid-cols-[92px_minmax(0,1fr)] [&_div]:gap-2 [&_dd]:m-0 [&_dd]:text-(--color-text) [&_dt]:font-black";
