...
export const transactionDetailSecondaryActionsClassName = "grid grid-cols-2 gap-2 max-[420px]:grid-cols-1";
export const transactionDetailSecondaryActionClassName = "min-h-10 w-full justify-center px-2.5 text-xs";
export const transactionDetailDangerActionClassName = "min-h-10 w-full justify-center px-2.5 text-xs";
