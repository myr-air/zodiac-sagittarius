...
export const expensesPageClassName = "expenses-page grid min-h-full min-w-0 content-start gap-3 bg-transparent px-6 py-[22px] pb-7 max-[1199px]:min-h-[calc(100dvh-48px)] max-[1199px]:gap-0 max-[1199px]:px-0 max-[1199px]:py-0 max-[1199px]:pb-0";
...
export const panelClassName = `expenses-panel grid min-h-0 gap-3 rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface) p-4 shadow-none ${workspaceResponsivePanelResetClassName} max-[767px]:p-3`;
...
export const balanceRowClassName = `${expenseOverviewRowClassName} grid-cols-[minmax(0,1fr)_auto] items-center border-(--color-border) bg-(--color-surface-subtle)`;
...
export const filterGridClassName = "grid grid-cols-[minmax(220px,1.35fr)_minmax(150px,220px)_minmax(150px,220px)_minmax(150px,220px)] items-end gap-2 max-[1199px]:grid-cols-2 max-[767px]:grid-cols-1";
...
export const ledgerWorkspaceClassName = "grid min-h-0 items-start grid-cols-[minmax(0,1fr)_340px] gap-3 max-[1023px]:grid-cols-1";
...
export const tableClassName = "expense-ledger-table w-full min-w-[930px] table-fixed border-collapse bg-(--color-surface) text-left text-sm";
export const tableHeaderClassName = "sr-only";
...
export const dayGroupRowClassName = "[&_td]:grid [&_td]:grid-cols-[minmax(0,1fr)_auto] [&_td]:items-center [&_td]:gap-3 [&_td]:rounded-(--radius-md)! [&_td]:border! [&_td]:border-(--color-route-border)! [&_td]:bg-(--color-route-soft)! [&_td]:px-3.5! [&_td]:py-2.5! [&_td]:text-xs [&_td]:font-black [&_td]:text-(--color-route) [&_td]:shadow-none! [&_strong]:tabular-nums";
...
export const transactionDetailBackdropClassName = "hidden max-[767px]:fixed max-[767px]:inset-0 max-[767px]:z-20 max-[767px]:block max-[767px]:bg-[rgb(15_23_42_/_0.38)]";
export const transactionDetailClassName = `expense-transaction-detail sticky top-3 grid max-h-[calc(100dvh-128px)] content-start gap-3 overflow-auto rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface) p-3.5 shadow-none max-[1023px]:static max-[767px]:fixed max-[767px]:inset-x-0 max-[767px]:bottom-0 max-[767px]:top-auto max-[767px]:z-30 max-[767px]:max-h-[72dvh] max-[767px]:rounded-t-(--radius-lg) max-[767px]:rounded-b-none max-[767px]:border-b-0 max-[767px]:shadow-[0_-14px_28px_rgb(15_23_42_/_0.08)]`;
...
export const transactionDetailActionsClassName = "grid gap-2 [&_button]:min-h-10 [&_button]:justify-start max-[767px]:pb-2";
...
export const dialogSegmentedItemClassName = "min-w-[88px] flex-1 px-3";
...
export const dialogCategoryGridClassName = "grid grid-cols-2 gap-2 max-[767px]:grid-cols-1";
export const dialogCategoryButtonClassName = "grid min-h-[72px] content-start gap-1 rounded-(--radius-md) border bg-(--color-surface) px-3 py-2.5 text-left transition hover:border-(--color-border-strong) focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--color-primary)";
export const dialogCategoryButtonActiveClassName = "shadow-[0_1px_4px_rgb(15_23_42_/_0.08)] ring-1 ring-inset";
