...
export const panelClassName = `expenses-panel grid min-h-0 gap-3 rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface) p-3.5 shadow-none ${workspaceResponsivePanelResetClassName}`;
...
export const commandActionsClassName = "expenses-command-actions flex flex-wrap items-center justify-end gap-2 max-[767px]:justify-start max-[767px]:[&>*]:flex-[1_1_180px]";
...
export const tableWrapClassName = `expenses-table-wrap min-h-0 overflow-auto rounded-(--radius-lg) border border-(--color-border) bg-[color-mix(in_srgb,var(--color-surface-subtle)_62%,var(--color-surface))] p-2 shadow-none ${workspaceResponsiveInlinePanelResetClassName} max-[1199px]:p-0 max-[767px]:hidden`;
export const tableClassName = "expense-ledger-table w-full min-w-[970px] table-fixed border-separate border-spacing-y-2.5 text-left text-sm";
export const tableHeaderClassName = "sr-only";
export const tableBodyClassName = "[&_td]:border-y [&_td]:border-(--color-border) [&_td]:bg-(--color-surface) [&_td]:px-3 [&_td]:py-3.5 [&_td]:align-middle [&_td:first-child]:rounded-l-(--radius-md) [&_td:first-child]:border-l [&_td:last-child]:rounded-r-(--radius-md) [&_td:last-child]:border-r [&_tr:hover_td]:border-(--color-border-strong) [&_tr:hover_td]:bg-[color-mix(in_srgb,var(--color-primary-soft)_34%,var(--color-surface))]";
...
export const mobileLedgerListClassName = `expense-mobile-ledger hidden gap-2.5 bg-[color-mix(in_srgb,var(--color-surface-subtle)_70%,var(--color-surface))] px-2.5 py-3 max-[767px]:grid ${workspaceResponsiveInlinePanelResetClassName}`;
...
export const mobileLedgerCardClassName = "grid gap-3 rounded-(--radius-md) border border-(--color-border) bg-(--color-surface) p-3";
