...
export const financeTabClassName = "inline-flex min-h-10 min-w-0 items-center justify-center overflow-hidden text-ellipsis whitespace-nowrap rounded-(--radius-sm) border border-transparent px-3 text-sm font-extrabold leading-5 text-(--color-text-muted) transition hover:bg-(--color-surface-subtle) hover:text-(--color-text) focus-visible:border-(--color-primary-border) max-[767px]:px-1.5 max-[767px]:text-[11px] max-[767px]:leading-4 max-[420px]:whitespace-normal";
...
export const overviewActionMenuClassName = "relative inline-grid";
...
export const commandActionsClassName = "expenses-command-actions flex min-w-0 items-center justify-end gap-2 [&>*]:min-h-10 max-[767px]:justify-start";
...
export const commandMenuPanelClassName = "absolute right-0 top-[calc(100%+6px)] z-20 grid min-w-[220px] gap-1 rounded-(--radius-md) border border-(--color-border) bg-(--color-surface) p-2 shadow-[0_12px_28px_rgb(15_23_42_/_0.12)] [&_button]:w-full [&_button]:justify-start max-[767px]:right-0";
...
export const ledgerTitleClassName = "min-w-0 max-w-full break-words text-[15px] font-black leading-5";
...
export const transactionDetailHeaderClassName = "grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3 border-b border-(--color-border) pb-3 [&_h2]:m-0 [&_h2]:min-w-0 [&_h2]:break-words [&_h2]:text-xl [&_h2]:font-black [&_h2]:leading-6 [&_h2]:text-(--color-text)";
...
export const accountPaybackRowClassName = "grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 border-t border-(--color-border) pt-2.5 first:border-t-0 first:pt-0";
