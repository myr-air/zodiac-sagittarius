...
export const tableWrapClassName = `expenses-table-wrap min-h-0 overflow-auto rounded-(--radius-lg) border border-(--color-border) bg-(--color-surface) p-2 shadow-none ${workspaceResponsiveInlinePanelResetClassName} max-[1199px]:p-0`;
...
export const tableBodyClassName = "[&_td]:border-y [&_td]:border-(--color-border) [&_td]:bg-(--color-surface) [&_td]:px-3 [&_td]:py-3 [&_td]:align-top [&_td:first-child]:rounded-l-(--radius-sm) [&_td:first-child]:border-l [&_td:last-child]:rounded-r-(--radius-sm) [&_td:last-child]:border-r [&_tr:hover_td]:bg-(--color-surface-subtle)";
...
export const ledgerAmountClassName = "inline-flex min-h-8 items-center rounded-(--radius-sm) border border-(--color-primary-border) bg-(--color-primary-soft) px-2.5 text-[13px] font-black tabular-nums text-(--color-primary-strong)";
