...
import { TripExpensesPage, type TripExpensesPageProps } from "../../TripExpensesPage";

export function renderExpenses(overrides: Partial<TripExpensesPageProps> = {}) {
  const props: TripExpensesPageProps = {
    trip: seedTrip,
