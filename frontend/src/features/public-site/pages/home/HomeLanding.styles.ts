...
import type { workflowStepMeta } from "./HomeLanding.meta";
...
export const homeBrandClassName =
...
export const homeBrandMarkClassName =
...
export const homeNavActionsClassName =
...
export const homeLargeButtonClassName = "home-large-button min-h-14 px-[26px] max-[760px]:min-h-[50px]";

export const homeHeroCopyClassName = "home-hero-copy relative z-[2] pb-11 max-[1120px]:pb-0";
export const homeHeroRouteClassName =
...
export const homeTitleSceneClassName = "home-title-scene relative isolate";
...
export const homeHeroDetailClassName =
...
export const homeHeroActionsClassName = "home-hero-actions mt-[34px] flex flex-wrap gap-[18px] max-[760px]:hidden";
export const homeSocialProofClassName = "home-social-proof mt-12 flex items-center gap-[18px] max-[760px]:mt-7 max-[760px]:items-start";
export const homeAvatarStackClassName =
...
export const homeSocialProofTextClassName = "m-0 text-sm font-bold leading-[22px] text-(--color-text-muted)";

export const homeProductPreviewClassName =
  "home-product-preview relative z-[1] scroll-mt-[18px] max-[1120px]:mb-[52px] max-[760px]:hidden";
export const homePreviewShellClassName =
...
export const homePreviewTopbarClassName =
...
export const homePreviewTitleClassName = "m-0 block text-base font-[850] leading-[22px] text-(--color-text)";
export const homePreviewMetaClassName = "mt-1 block text-[13px] font-bold text-(--color-text-subtle)";
export const homePreviewFriendsClassName =
...
export const homePreviewGridClassName = "home-preview-grid grid min-h-[492px] min-w-0 grid-cols-[168px_minmax(0,1fr)] max-[760px]:min-h-0 max-[760px]:grid-cols-1";
export const homePreviewMenuClassName =
...
export const homePreviewMenuItemClassName =
...
export const homePreviewMainClassName = "home-preview-main grid min-w-0 gap-[18px] p-6 max-[760px]:p-4";
export const homeDayStripClassName =
...
export const homeDayCardClassName =
...
export const homeDayPillClassName =
  "inline-flex min-h-[22px] items-center rounded-(--radius-sm) bg-(--color-route-soft) px-[7px] text-[11px] font-[850] text-(--color-route)";
export const homeDayTitleClassName = "mt-[9px] mb-0 text-[15px] font-[840] leading-5 text-(--color-text)";
export const homeDayTextClassName = "mt-1 mb-0 text-[12.5px] font-semibold leading-[18px] text-(--color-text-muted)";
export const homeDayImageClassName =
...
export const homePreviewBottomClassName = "home-preview-bottom grid grid-cols-[minmax(0,1fr)_220px] gap-4 max-[760px]:grid-cols-1";
export const homeMapCardClassName =
...
export const homeMapSvgClassName =
...
export const homeMapWaterClassName = "home-map-water fill-[rgb(125_211_252_/_0.42)]";
export const homeMapRouteClassName = "home-map-route fill-none stroke-(--color-sky) [stroke-linecap:round] [stroke-width:8]";
export const homeChecklistCardClassName =
...
export const homeChecklistHeaderClassName = "flex min-w-0 items-center justify-between gap-3.5";
export const homeChecklistTitleClassName = "min-w-0 text-sm font-[850] leading-[18px] text-(--color-text)";
export const homeChecklistProgressClassName = "shrink-0 whitespace-nowrap text-[11px] font-[750] leading-4 text-(--color-text-subtle)";
export const homeChecklistMeterClassName = "home-checklist-meter h-2.5 w-full overflow-hidden rounded-full border-0";
export const homeChecklistListClassName = "grid list-none gap-2.5 p-0 m-0";
export const homeChecklistItemClassName = "home-checklist-item relative pl-6 text-[12.5px] leading-[19px]";

export const homeWorkflowClassName =
...
export const homeWorkflowTitleClassName = "m-0 text-[42px] font-black leading-[52px] text-(--color-text) [text-wrap:balance] max-[760px]:text-[30px] max-[760px]:leading-[38px]";
export const homeWorkflowHighlightClassName = "home-workflow-highlight relative inline-block text-(--color-primary-strong)";
export const homeWorkflowDetailClassName = "mx-auto mt-5 mb-0 text-xl font-[450] leading-8 text-(--color-text-muted) max-[760px]:text-base max-[760px]:leading-[26px]";
export const homeWorkflowGridClassName = "home-workflow-grid mx-auto mt-[92px] grid w-[min(100%,1320px)] grid-cols-3 gap-[72px] max-[760px]:mt-[42px] max-[760px]:grid-cols-1 max-[760px]:gap-3.5";
export const homeWorkflowItemClassName =
...
export const homeWorkflowNumberClassName =
...
export const homeWorkflowIconClassName =
...
export const homeWorkflowItemTitleClassName = "m-0 text-[30px] font-black leading-[38px] text-(--color-text) max-[760px]:text-2xl max-[760px]:leading-8";
export const homeWorkflowItemTextClassName = "m-0 text-xl font-[450] leading-[34px] text-(--color-text-muted) max-[760px]:text-base max-[760px]:leading-[26px]";

export const homeFeatureBandClassName =
...
export const homeFeatureTitleClassName = "m-0 text-[30px] font-black leading-10 text-(--color-text) max-[760px]:text-2xl max-[760px]:leading-8";
export const homeFeatureTextClassName = "mx-auto mt-2 ml-0 max-w-[760px] text-base font-[550] leading-[26px] text-(--color-text-muted)";
export const homeFooterClassName =
...
export const homeFooterBrandClassName = "home-footer-brand grid gap-2.5";
export const homeFooterCopyClassName = "m-0 max-w-[560px] text-sm font-[550] leading-[22px] text-(--color-text-muted)";
export const homeFooterLinksClassName = "home-footer-links flex flex-wrap justify-end gap-2.5 max-[760px]:justify-start";
export const homeFooterLinkClassName =
