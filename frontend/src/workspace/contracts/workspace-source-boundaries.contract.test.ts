...
describe("Sagittarius workspace source boundaries", () => {
  ...
  it("keeps workspace dialog chrome styles shared", () => {
    ...
    const importDialogActions = readFileSync(join(frontendRoot, "src/trip/workspace/use-trip-workspace-import-dialog-actions.ts"), "utf8");
  ...
  it("keeps workspace page form dialogs on shared chrome", () => {
    ...
    const photoDeleteDialog = readFileSync(join(frontendRoot, "src/features/workspace/pages/photos/components/PhotoAlbumDeleteDialog.tsx"), "utf8");
    const workspaceDeleteDialog = readFileSync(join(frontendRoot, "src/trip/workspace/TripWorkspaceDeleteDialog.tsx"), "utf8");
