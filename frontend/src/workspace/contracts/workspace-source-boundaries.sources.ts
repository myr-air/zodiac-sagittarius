...
export const workspaceBoundarySourcePaths = {
  ...
  sagittariusAppTestAccountApi:
    "src/trip/workspace/sagittarius-app/testing/support/sagittarius-app-account-api.ts",
  ...
  importApplyCommandInputs:
    "src/trip/workspace/sagittarius-app/hooks/itinerary/command-inputs/workspace-itinerary-import-apply-inputs.ts",
  ...
  administrationHook: "src/trip/workspace/sagittarius-app/hooks/use-workspace-administration.ts",
  administrationCommandTypes:
    "src/trip/workspace/sagittarius-app/hooks/administration/workspace-administration-command-types.ts",
  memberAdminActions:
    "src/trip/workspace/sagittarius-app/hooks/administration/use-workspace-member-admin-actions.ts",
  memberPatchActions:
    "src/trip/workspace/sagittarius-app/hooks/administration/use-workspace-member-patch-actions.ts",
  accountClaimActions:
    "src/trip/workspace/sagittarius-app/hooks/administration/use-workspace-account-claim-actions.ts",
  tripSettingsActions:
    "src/trip/workspace/sagittarius-app/hooks/administration/use-workspace-trip-settings-actions.ts",
  ...
  saveItineraryBookingTicketCommand:
    "src/trip/workspace/sagittarius-app/hooks/bookings/use-save-itinerary-booking-ticket-command.ts",
  ...
  bookingDocCommandTypes:
    "src/trip/workspace/sagittarius-app/hooks/bookings/workspace-booking-doc-command-types.ts",
  createBookingDocCommand:
    "src/trip/workspace/sagittarius-app/hooks/bookings/use-create-booking-doc-command.ts",
  deleteBookingDocCommand:
    "src/trip/workspace/sagittarius-app/hooks/bookings/use-delete-booking-doc-command.ts",
  ...
  taskCommandTypes:
    "src/trip/workspace/sagittarius-app/hooks/records/workspace-task-command-types.ts",
  createTaskCommand:
    "src/trip/workspace/sagittarius-app/hooks/records/use-create-workspace-task-command.ts",
  toggleTaskStatusCommand:
    "src/trip/workspace/sagittarius-app/hooks/records/use-toggle-workspace-task-status-command.ts",
  suggestionActionsHook:
    "src/trip/workspace/sagittarius-app/hooks/records/use-workspace-suggestion-actions.ts",
  suggestionCommandTypes:
    "src/trip/workspace/sagittarius-app/hooks/records/workspace-suggestion-command-types.ts",
  suggestSelectedStopCommand:
    "src/trip/workspace/sagittarius-app/hooks/records/use-suggest-selected-stop-command.ts",
  reviewSuggestionCommand:
    "src/trip/workspace/sagittarius-app/hooks/records/use-review-workspace-suggestion-command.ts",
  ...
  stopNoteCommandTypes:
    "src/trip/workspace/sagittarius-app/hooks/records/workspace-stop-note-command-types.ts",
  createStopNoteCommand:
    "src/trip/workspace/sagittarius-app/hooks/records/use-create-workspace-stop-note-command.ts",
  updateStopNoteCommand:
    "src/trip/workspace/sagittarius-app/hooks/records/use-update-workspace-stop-note-command.ts",
  deleteStopNoteCommand:
    "src/trip/workspace/sagittarius-app/hooks/records/use-delete-workspace-stop-note-command.ts",
  ...
  tripJoinParticipantStep: "src/features/account/components/trip-join-gate/composition/TripJoinParticipantStep.tsx",
  ...
  weatherForecastStripStory: "src/shared/components/weather/storybook/WeatherForecastStrip.stories.tsx",
  weatherBriefingDrawerStory: "src/shared/components/weather/storybook/WeatherBriefingDrawer.stories.tsx",
