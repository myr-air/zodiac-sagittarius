...
export { itineraryExportSchema, itineraryExportVersion } from "./itinerary-import-export-schema";
...
export function parseItineraryImportDocument(source: string): ItineraryExportDocument {
  ...
  if (!looksLikeJsonImport(normalizedSource)) {
    const spreadsheetDocument = parseSpreadsheetItineraryImportDocument(normalizedSource);
    return {
      ...spreadsheetDocument,
