...
import { nextClientMutationId, nextLocalStopNoteId, nextLocalSuggestionId, nextLocalTaskId } from "@/src/trip/local-ids";
...
import type { ItineraryItem, Suggestion, StopNote, Trip, TripParticipantSession, TripTask } from "@/src/trip/types";
...
function useWorkspaceRecordState(initialTrip: InitialTripState) {
...
function useWorkspaceRecordActions({
  canCreateSuggestion,
