...
export function mapExpense(expense: ExpenseResponse): Expense {
  return {
    ...
    storedValueCardId: expense.storedValueCardId ?? null,
    storedValueCardName: expense.storedValueCardName ?? null,
    storedValueTransactionType: expense.storedValueTransactionType ?? null,
