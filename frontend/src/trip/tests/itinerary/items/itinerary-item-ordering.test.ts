...
describe("itinerary item ordering", () => {
  it("sorts items by day, then timed order, then fallback", () => {
    const dayOneMorning = buildTripFixtureItineraryItem({
      id: "day-one-morning",
      day: "2026-06-17",
      startTime: "09:00",
    ...
    const dayOneEarly = buildTripFixtureItineraryItem({
      id: "day-one-early",
      day: "2026-06-17",
      startTime: "08:00",
      timeMode: "scheduled" as const,
    ...
    const dayOneFlexible = buildTripFixtureItineraryItem({
      id: "day-one-flex",
      day: "2026-06-17",
      startTime: "",
    ...
    const dayTwo = buildTripFixtureItineraryItem({
      id: "day-two-main",
      day: "2026-06-18",
      startTime: "07:30",
      timeMode: "scheduled" as const,
  ...
  it("orders parents before direct children within a day while preserving child order", () => {
    const parent = buildTripFixtureItineraryItem({
      id: "parent-activity",
      day: "2026-06-18",
      startTime: "09:00",
      timeMode: "scheduled" as const,
    ...
    const sibling = buildTripFixtureItineraryItem({
      id: "sibling-activity",
      day: "2026-06-18",
      startTime: "11:00",
      timeMode: "scheduled" as const,
