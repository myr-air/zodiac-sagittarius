...
describe("Sagittarius project scaffold", () => {
  it("separates frontend and backend services behind a root Makefile", () => {
    ...
    expect(existsSync(join(frontendRoot, "src/trip/expenses-api-requests.test.ts"))).toBe(true);
    ...
    expect(existsSync(join(frontendRoot, "src/trip/itinerary-api-merges.test.ts"))).toBe(true);
    ...
    expect(existsSync(join(frontendRoot, "src/trip/workspace/sagittarius-app/SagittariusApp.account-session-restore.test.tsx"))).toBe(true);
    ...
    expect(existsSync(join(frontendRoot, "src/features/account/components/trip-join-gate/TripJoinGate.api-errors.test.tsx"))).toBe(true);
    ...
    expect(existsSync(join(frontendRoot, "src/features/itinerary/components/route-map/route-map-live-map-test-support.ts"))).toBe(true);
