  ...
  en: {
    ...
    access: {
      ...
      highlights: {
        ...
        secure: "Email code, password, and passkey after email",
        history: "Trip history and owner rights stay connected",
        trusted: "Trusted devices can return faster",
        registerSecure: "Email code or password to create account",
        registerHistory: "Trip history starts in one account",
        registerOwner: "Owner rights stay connected from day one",
      },
      tabs: {
        account: "Account",
        temp: "Temp access",
      ...
      emailLogin: {
        ...
        emailDetail: "Start with your email. The next step will show the available options.",
        methodDetail: "Choose one way to continue.",
        passwordDetail: "Enter the password for this account.",
  ...
  th: {
    ...
    access: {
      ...
      highlights: {
        ...
        secure: "มี email code, password และ passkey หลังกรอกอีเมล",
        history: "ประวัติ trip และสิทธิ owner ยังผูกกัน",
        trusted: "Trusted device กลับมาใช้ได้ไวขึ้น",
        registerSecure: "สร้าง account ด้วย email code หรือ password",
        registerHistory: "ประวัติ trip เริ่มเก็บใน account เดียว",
        registerOwner: "สิทธิ owner ผูกตั้งแต่วันแรก",
      },
      tabs: {
        account: "Account",
        temp: "Temp access",
      ...
      emailLogin: {
        errors: {
          startFailed: "เริ่ม sign in ไม่สำเร็จ",
        ...
        emailTitle: "กรอกอีเมล",
        methodTitle: "เลือกวิธีเข้าใช้งาน",
        passwordTitle: "ใช้ password",
        expiresAt: ({ value }: { value: string }) => `หมดอายุ ${value}`,
        emailDetail: "เริ่มจากอีเมล แล้วค่อยเลือกวิธีใน step ถัดไป",
        methodDetail: "เลือกหนึ่งวิธีเพื่อไปต่อ",
        passwordDetail: "กรอก password ของ account นี้",
        ...
        signInAs: "เข้า account ด้วย",
        createFor: "สร้าง account ให้",
        email: "อีเมล *",
        password: "รหัสผ่าน",
        continue: "ไปต่อ",
        ...
        signInWithPasskey: "เข้า account ด้วย passkey",
