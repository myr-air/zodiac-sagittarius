...
export const messages = {
  ...
  th: {
    ...
    tripSettings: {
      ...
      noImpact: "ทุก stop ยังอยู่ในช่วงวันที่ทริปใหม่",
      outsideStops: ({ count }: { count: number }) => `${count} stop จะอยู่นอกช่วงวันที่ทริปใหม่`,
      editLocked: "เฉพาะ owner และ organizer ที่แก้ trip settings ได้",
      invalidDate: "วันจบทริปต้องเป็นวันเดียวกันหรือหลังวันเริ่มทริป",
      save: "Save changes",
      saving: "Saving...",
      saved: "บันทึก trip settings แล้ว",
      saveFailed: "บันทึก trip settings ไม่สำเร็จ",
      currentRole: ({ role }: { role: string }) => `Role ปัจจุบัน: ${role}`,
    },
    dates: {
