export const enExpensesMessages = {
    ...
    tools: {
      ...
      calculatorDescription: "Add or subtract line amounts before saving an expense.",
      calculatorExpression: "Formula",
      calculatorPlaceholder: "90+64+40-14",
      calculatorResult: ({ amount }: { amount: string }) => `Result ${amount}`,
      calculatorInvalid: "Invalid formula. Use numbers with + and - only.",
      calculatorEmpty: "Enter an amount like 90+64+40-14.",
    },
    categories: {
      food: "Food",
      transport: "Transport",
    ...
    dialog: {
      ...
      amountExpressionPreview: ({ amount }: { amount: string }) => `Calculated ${amount}`,
      amountExpressionInvalid: "Invalid amount formula. Use numbers with + and - only.",
