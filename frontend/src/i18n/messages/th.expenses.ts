export const thExpensesMessages = {
    ...
    tools: {
      label: "เครื่องมือบัญชี",
      calculatorTitle: "เครื่องคิดเลข",
      calculatorDescription: "คำนวณยอดย่อยก่อนนำไปบันทึกในรายการใช้จ่าย",
      calculatorExpression: "สมการ",
      calculatorPlaceholder: "90+64+40-14",
      calculatorResult: ({ amount }: { amount: string }) => `ผลลัพธ์ ${amount}`,
      calculatorInvalid: "สมการไม่ถูกต้อง ใช้ตัวเลข เครื่องหมาย + และ - เท่านั้น",
      calculatorEmpty: "ใส่ยอด เช่น 90+64+40-14",
    },
    categories: {
      food: "อาหาร",
      transport: "เดินทาง",
    ...
    dialog: {
      ...
      amountExpressionPreview: ({ amount }: { amount: string }) => `คำนวณได้ ${amount}`,
      amountExpressionInvalid: "สมการจำนวนเงินไม่ถูกต้อง ใช้ตัวเลข เครื่องหมาย + และ - เท่านั้น",
